      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-5">
            ...
            {[
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-br ${item.gradient} flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
          ...
          <div className="glass border border-border rounded-2xl p-6">
            <h3 className="font-display font-bold text-lg mb-5">Send a Message</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full btn-shimmer text-white py-3.5 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-lg hover:shadow-primary/30 hover:-translate-y-0.5 transition-transform duration-200"
              >
                {sent ? (
                  "Message Sent! ✓"
                ) : (
