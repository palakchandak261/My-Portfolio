...
const positions = [
  { role: "Aesthetic Coordinator", org: "Social Welfare Development Committee, VIT Pune" },
  { role: "Aesthetic Volunteer",   org: "EPEC (Event Planning & Execution Committee), VIT Pune" },
];
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-shrink-0 flex flex-col gap-5 w-full lg:w-auto">
            <div className="relative mx-auto lg:mx-0">
              ...
              <div
                className="absolute -top-3 -left-3 glass border border-accent/30 px-3 py-1.5 rounded-full text-xs font-bold text-accent shadow-lg animate-float"
              ...
              <div className="space-y-2">
                {positions.map((p) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-semibold text-foreground leading-tight">{p.role}</p>
